...
<body class="w-full flex flex-col items-center relative bg-light-500 text-black-900 font-medium leading-none dark:bg-dark-900 dark:text-light-900">
  <header id="head" class="w-full relative ad:mb-36 tb:mb-[60px] lg:mb-48 md:mb-56 xl:mb-[80px]">
    ...
    <div id="menu" class="menu">
      <ul class="menu__content">
        ...
        <li class="menu__content-col menu__help">
          ...
          <form action="/help-request" class="menu__help-form" method="POST">
            <ul class="menu__help-inputs">
              <li>
                <label for="customerName" class="menu__help-label">Ваше имя и фамилия</label>
                <input type="text" name="customerName" id="customerName" class="menu__help-input border border-light-900 focus:ring-1 focus:ring-brand-900" placeholder="Иван Иванов" required>
              </li>
              <li class="menu__help-item">
                <label for="customerPhone" class="menu__help-label">Ваш телефон</label>
                <input type="tel" name="customerPhone" id="customerPhone" class="menu__help-input border border-light-900 focus:ring-1 focus:ring-brand-900" placeholder="+7 923 900 90 90" required>
              </li>
            </ul>
    ...
    <div class="w-full ad:flex ad:flex-col lg:flex-row tb:items-center lg:justify-between ad:mt-[80px] md:mt-[100px] xl:mt-[128px]">
      <div class="ad:mt-12 ph:w-[390px] tb:w-[470px] lg:w-[498px] md:w-[592px] xl:w-[750px] flex flex-col tb:items-center lg:items-start ad:order-2 lg:order-1 ad:px-16 tb:px-0 lg:pl-32 xl:pl-48">
        ...
        <a href="#courses" class="block w-fit px-24 py-20 ad:mt-24 ph:mt-36 tb:text-18 lg:text-16 md:mt-48 ad:rounded-8 lg:rounded-12 md:rounded-16 bg-brand-900 text-light-400 hover:shadow-btn font-bold">Смотреть курсы и программы</a>
      </div>
  ...
  <section id="courses" class="ad:px-16 ad:mt-36 ad:mb-36 lg:px-32 tb:mt-48 tb:mb-48 md:mt-56 lg:mb-48 md:mb-56 xl:mt-[80px] xl:mb-[80px] ad:flex ad:flex-col ad:items-start ad:justify-start tb:items-center tb:justify-center">
    ...
    <div class="w-full flex ad:flex-col lg:flex-row lg:items-start lg:justify-between ad:mt-36 md:mt-48 ad:p-16 lg:p-24 xl:px-32 xl:py-36 ad:rounded-12 lg:rounded-16 md:rounded-32 bg-brand-900 dark:bg-dark-800">
      <div class="lg:w-[350px] md:w-[390px] xl:w-[436px]">
        ...
        <p class="ad:mt-8 lg:mt-12 lg:text-16 md:text-18 xl:text-20 font-light leading-tight text-light-400 dark:text-light-800">Оставьте заявку на обратный звонок. <br> 
          Мы свяжемся с вами в ближайшее время 
          и поможем в выборе курса или программы</p>
      </div>
      <form action="" method="post" class="lg:w-2/3 md:w-1/2">
        <ul class="flex ad:flex-col lg:flex-row ad:items-start lg:items-center ad:mt-24 lg:mt-0">
          <li class="ad:w-full lg:mr-32 xl:mr-36 flex flex-col">
            <label class="ad:text-16 lg:text-18 xl:text-22 text-light-400" for="helperClientName">Ваше имя и фамилия</label>
            <input class="ad:mt-12 xl:mt-16 lg:px-12 md:px-16 ad:py-[10px] md:py-[14px] lg:text-16  bg-brand-900 text-light-400  border-2 border-light-400 focus:border-light-400 ad:rounded-8 lg:rounded-12 md:rounded-16 placeholder:text-light-900 dark:bg-dark-800" type="text" name="helperClientName" id="helperClientName" placeholder="Иван Иванов" required>
          </li>
          <li class="ad:w-full ad:mt-16 lg:mt-0 lg:mr-32 xl:mr-36 flex flex-col">
            <label class="ad:text-16 lg:text-18 xl:text-22 text-light-400" for="helperClientPhone">Ваш телефон</label>
            <input class="ad:mt-12 xl:mt-16 lg:px-12 md:px-16 ad:py-[10px] md:py-[14px]  bg-brand-900 text-light-400 border-2 border-light-400 focus:border-light-400 ad:rounded-8 lg:rounded-12 md:rounded-16 placeholder:text-light-900 dark:bg-dark-800" type="tel" name="helperClientPhone" id="helperClientPhone" placeholder="+7 900 900 90 90" required>
          </li>
          <li class="ad:w-full ad:self-start lg:self-end ad:mt-24">
            <button class="ad:w-full ad:px-16 lg:px-24 md:px-32 ad:py-16 md:py-20 bg-light-400 text-black-900 ad:rounded-8 lg:rounded-12 md:rounded-16 hover:bg-brand-900 lg:hover:outline lg:hover:outline-2 lg:hover:outline-light-400 lg:hover:text-light-400 dark:bg-brand-900 dark:text-light-400 dark:hover:shadow-btn dark:hover:outline-none font-bold" type="submit">Позвоните мне</button>
          </li>
        </ul>
        <div class="flex ad:items-center xl:items-start ad:mt-16 md:mt-16">
          ...
          <p class="shrink-1 ad:ml-8 md:ml-12 ad:text-14 xl:text-16 text-light-400 xl:leading-tight tracking-wide">Отправляя данную форму вы автоматически согласны на обработку <br class="hidden xl:inline-block"> персональных данных</p>
        </div>
      </form>
    </div>
  </section>
  <section id="feedbacks" class="ad:px-16 ad:mt-36 ad:mb-[80px] tb:mb-[60px] lg:mb-0 lg:px-32 tb:mt-48 md:mt-48 md:mb-56 xl:mt-[80px] xl:mb-[80px] ad:flex ad:flex-col ad:items-start ad:justify-start tb:items-center tb:justify-center">
    ...
    <ul class="feedbacks-slider self-center block ad:mt-36 tb:mt-48 md:mt-56 xl:mt-64">
      <li class="feedbacks-slider__item flex ad:flex-col tb:flex-row ad:flex-start tb:items-center ad:p-24 lg:p-32 bg-light-700 rounded-16 dark:bg-dark-800">
        <img class="ad:w-40 ad:h:40 dark:brightness-90" src="/src/img/landing/feedbacks/feedback-author.png" alt="feedback-author">
        <div class="tb:ml-24 md:ml-32">
          <h3 class="ad:text-24 ad:mt-36 tb:mt-0 font-bold dark:text-light-400">Саша Малышева</h3>
          <p class="mt-8 ad:text-16 leading-tight text-black-800 dark:text-light-900">Я прошла обучение по курсу “1С: Управление торговлей “ и “1С: Предприятие. Спасибо за такой полезный и насыщенный курс. Помимо знаний я получила огромный заряд энегрии и стимул к дальнейшему обучению!</p>
        </div>
      </li>
      <li class="feedbacks-slider__item flex ad:flex-col tb:flex-row ad:flex-start tb:items-center ad:p-24 lg:p-32 bg-light-700 rounded-16 dark:bg-dark-800">
        <img class="ad:w-40 ad:h:40 dark:brightness-90" src="/src/img/landing/feedbacks/feedback-author.png" alt="feedback-author">
