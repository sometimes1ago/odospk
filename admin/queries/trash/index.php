  ...
  <h1 class="text-32 md:text-48 font-bold">Заявки • Корзина</h1>
    <div class="w-full h-[92%] flex items-center md:items-start relative flex-col mt-16 md:mt-24 p-16 rounded-16 bg-light-400 shadow-section">
      ...
      <ul class="flex items-center lg:w-full mt-16 font-medium">
        ...
        <li class="headerSortBy lg:max-w-[264px] xl:max-w-[336px] lg:min-w-[264px] xl:min-w-[336px] flex items-center border-2 border-light-900 border-collapse -ml-2 px-12 py-8 cursor-pointer" data-sortByValue="course">
          <svg class="lg:w-20 lg:h-20 mr-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
        ...
        <li class="headerSortBy lg:max-w-[222px] xl:max-w-[245px] lg:min-w-[222px] xl:min-w-[245px] flex items-center border-2 border-light-900 border-collapse -ml-2 px-12 py-8 cursor-pointer" data-sortByValue="client">
          <svg class="lg:w-20 lg:h-20 mr-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
        ...
        <li class="headerSortBy lg:max-w-[168px] xl:max-w-[197px] lg:min-w-[168px] xl:min-w-[197px] flex items-center border-2 border-light-900 border-collapse -ml-2 px-12 py-8 cursor-pointer" data-sortByValue="phone">
          <svg class="lg:w-20 lg:h-20 mr-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
        ...
        <li class="headerSortBy lg:max-w-[138px] xl:max-w-[169px] lg:min-w-[138px] xl:min-w-[169px] flex items-center border-2 border-light-900 border-collapse -ml-2 px-12 py-8 cursor-pointer" data-sortByValue="date">
          <svg class="lg:w-20 lg:h-20 mr-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
        ...
        <li class="headerSortBy lg:max-w-[155px] xl:max-w-[171px] lg:min-w-[155px] xl:min-w-[171px] flex items-center border-2 border-light-900 border-collapse -ml-2 px-12 py-8 rounded-tr-8 rounded-br-8 cursor-pointer" data-sortByValue="status">
          ...
          <div class="queries__actions w-full font-bold shadow-lg p-12 md:p-16 bg-light-400 absolute bottom-0 border border-light-900 rounded-12" method="POST">
            ...
            <ul class="mt-16 md:mt-24 flex items-center">
              <li class="mr-12 md:mr-16 last:mr-0">
                <button class="queries__action flex items-center px-12 py-8 md:px-16 md:py-[10px] font-medium bg-light-600 border border-light-900 rounded-8" name="restore" value="yes" type="submit">
                  ...
                  <p class="text-14 md:text-16">Восстановить</p>
                </button>
              </li>
              <li class="mr-12 md:mr-16 last:mr-0">
                <button class="queries__action flex items-center px-12 py-8 md:px-16 md:py-[10px] font-medium bg-light-600 border border-light-900 rounded-8" name="remove" value="yes" type="submit">
                  <svg class="mr-8 md:w-24 md:h-24" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  ...
                  <p class="text-14 md:text-16">Удалить окончательно</p>
                </button>
              </li>
              <li class="mr-12 md:mr-16 last:mr-0">
                <button class="queries__action queries__trash-clear flex items-center px-12 py-8 md:px-16 md:py-[10px] font-medium bg-state-error border border-state-error rounded-8" name="clear" value="yes" type="submit">
                  <svg class="mr-8 md:w-24 md:h-24" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  ...
                  <p class="text-14 md:text-16 text-light-400">Очистить корзину</p>
                </button>
              </li>
            </ul>
          </div>
