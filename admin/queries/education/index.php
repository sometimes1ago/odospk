      ...
      <?php if (!empty($queries) && is_array($queries)) : ?>
        <form class="w-full max-h-[90%] mt-12 relative" action="<?=$_SERVER['PHP_SELF']?>" method="POST">
          ...
          <ul class="mt-16 flex items-center">
            ...
            <li class="mr-12 last:mr-0">
              <button class="queries__action flex items-center px-12 py-8 font-medium bg-light-600 border border-light-900 rounded-8" name="archiving" value="yes" type="submit">
                <svg class="mr-8" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <p class="text-14">Архивировать</p>
              </button>
            </li>
            <li class="mr-12 last:mr-0">
