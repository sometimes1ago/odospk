...
<body class="w-full h-screen flex text-black-900 leading-none bg-light-600 overflow-hidden">
  ...
  <section class="w-full px-24 py-24 font-medium text-black-900">
    ...
    <div class="w-full h-[92%] flex items-center md:items-start relative flex-col mt-16 md:mt-24 p-16 rounded-16 bg-light-400 shadow-section">
            ...
            <ul class="mt-16 xl:mt-24 flex items-center">
              <li class="mr-12 md:mr-16 last:mr-0">
                <button class="queries__action flex items-center px-12 py-8 font-medium bg-light-600 border border-light-900 rounded-8" name="unarchiving" value="yes" type="submit">
                  ...
                  <p class="text-14 xl:text-16">Разархивировать</p>
                </button>
              </li>
              <li class="mr-12 md:mr-16 last:mr-0">
      ...
      <?php else : ?>
        <div class="flex items-center animate__animated animate__fadeIn justify-center h-full">
          <div class="flex flex-col items-center">
            ...
            <p class="mt-8 text-16 text-black-800">Вы еще не архивировали заявки на обучение</p>
          </div>
        </div>
      <?php endif; ?>
    </div>
