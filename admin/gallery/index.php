...
<body class="w-full h-screen text-black-900 flex leading-none bg-light-600">
  ...
  <section class="w-full px-24 py-24 font-medium text-black-900">
    ...
    <div class="w-full h-[92%] flex relative flex-col mt-16 p-16 rounded-16 bg-light-400 shadow-section">
      ...
      <form class="relative" action="<?=$_SERVER['PHP_SELF']?>" method="POST" enctype="multipart/form-data">
        <ul class="w-full mt-16 max-h-[460px] flex flex-wrap scrollbar overflow-y-scroll">
          <li class="gallery__item min-w-[200px] h-[142px] flex items-center justify-center bg-brand-900 mr-16 mb-16 last:mr-0 last:mb-0 rounded-8 cursor-pointer">
          ...
          <li class="gallery__item gallery__item-active relative min-w-[200px] h-fit mr-16 mb-16 last:mr-0 last:mb-0">
            <input class="block absolute top-8 left-8 rounded-4 p-8 bg-light-400" type="checkbox" value="selected" name="photo-{id}" id="photo-{id}">
            <label for="photo-{id}" class="block">
              <img class="block w-full h-[142px] rounded-8 cursor-pointer" src="/src/img/gallery/100 ЛТР.jpg" intrinsicsize alt="100 лтр.jpg">
            </label>
          </li>
          <li class="gallery__item gallery__item-active relative min-w-[200px] h-fit mr-16 mb-16 last:mr-0 last:mb-0">
            <input class="block absolute top-8 left-8 rounded-4 p-8 bg-light-400" type="checkbox" value="selected" name="photo-{id}" id="photo-{id}">
        ...
        <div class="w-full absolute bottom-0 p-12 bg-light-400 border border-light-900 rounded-8 shadow-xl">
          ...
          <ul class="flex mt-16">
            <li class="mr-16 last:mr-0">
              <button type="submit" class="queries__trash-clear flex items-center px-12 py-8 font-medium bg-state-error border border-state-error rounded-8">
