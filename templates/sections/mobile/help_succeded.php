...
<button type="button" class="callOrderSucceded ad:w-full mt-24 md:mt-32 xl:mt-36 text-16 font-bold md:text-18 p-16 md:p-[19px] bg-brand-900 text-light-400 ad:rounded-8 lg:rounded-12 xl:rounded-16 cursor-pointer lg:hover:shadow-btn">Спасибо!</button>