<ul class="w-full flex items-center justify-between z-20">
  ...
  <li class="flex items-center">
    <div class="ml-12 lg:mr-12 md:mr-0">
      <form action="<?=$_SERVER['PHP_SELF']?>" method="post"  class="search">
        ...
        <div class="animate__animated animate__fadeIn animate__fast search__content shadow-xl">
          ...
          <div class="dropdown dropdown__light z-10" data-index="0">
            <div class="dropdown__btn">
              <p class="dropdown__btn-text dropdown__searchBy" data-dropdownValue="Курсу или программе">Курсу или программе</p>
            ...
            <ul class="animate__animated animate__fadeIn animate__faster dropdown__options searchPropOptions">
          ...
          <input type="text" name="searchValue" id="searchValue" class="search__input searchByValue" placeholder="Значение для поиска">
          <input class="searchSender w-full text-14 tb:mt-24 mt-24 md:text-16 xl:text-18 font-medium text-light-400 bg-brand-900 py-[17px] md:py-18 rounded-8 cursor-pointer hover:shadow-btn" type="submit" value="Показать">
        </div>
      </form>
    </div>
