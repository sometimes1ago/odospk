    ...
    <div class="ml-12 lg:mr-12 md:mr-0">
      <form action="<?=$_SERVER['PHP_SELF']?>" class="search">
        ...
        <div class="search__content shadow-xl">
          ...
          <input class="sortByDateSender w-full text-14 tb:mt-24 mt-24 md:text-16 xl:text-18 font-medium text-light-400 bg-brand-900 py-[17px] md:py-18 rounded-8 cursor-pointer hover:shadow-btn" type="submit" name="removeFeedbackSender" value="Показать">
        </div>
      </form>
    </div>
